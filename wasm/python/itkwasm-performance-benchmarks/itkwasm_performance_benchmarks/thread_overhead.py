...
def thread_overhead(
    ...
    :rtype:  Any
    """
    func = environment_dispatch("itkwasm_performance_benchmarks", "thread_overhead")
    output = func(no_print_stdout=no_print_stdout, expanded_report=expanded_report, no_print_system_info=no_print_system_info, no_print_report_head=no_print_report_head, iterations=iterations, threads=threads)
    return output
